"""Webauthn (FIDO2) and Time-based One Time Password auth module."""
...
STORAGE_VERSION = 1
STORAGE_KEY = "auth_module.webauthn_totp"
STORAGE_USERS = "users"
...
@MULTI_FACTOR_AUTH_MODULES.register("webauthn_totp")
class WebauthnTotpAuthModule(MultiFactorAuthModule):
...
class TotpSetupFlow(SetupFlow):
    ...
    def __init__(
        self, auth_module: WebauthnTotpAuthModule, setup_schema: vol.Schema, user: User
    ) -> None:
        """Initialize the setup flow."""
        super().__init__(auth_module, setup_schema, user.id)
        # to fix typing complaint
        self._auth_module: WebauthnTotpAuthModule = auth_module
        self._user = user
